...
INPUT_FILE = "carlsbad_links.txt"
OUTPUT_FILE = "carlsbad_knowledge_base_structured.json"
MAX_CHARS = 2000
...
# === Move output to clients/carlsbad/data === [ADDED]
DEST_PATH = "../clients/carlsbad/data/carlsbad_knowledge_base_structured.json"  # [ADDED]
try:  # [ADDED]
